...
<div className="One-Skin" key={props.index} >
  ...
  <div className="Skins-cost_float">
    <p className="Skins-cost-shadow"><span>StatTrack</span> Factory New:<span className="price_skin">{props.event.st_cost_factory} $</span></p>
    <p><span>StatTrack</span> Minimal Wear:<span className="price_skin">{props.event.st_cost_minimal} $</span></p>
    <p className="Skins-cost-shadow"><span>StatTrack</span> Field-Test:<span className="price_skin">{props.event.st_cost_field} $</span></p>
    <p ><span>StatTrack</span> Well-Worm:<span className="price_skin">{props.event.st_cost_wellworm} $</span></p>
    <p className="Skins-cost-shadow"><span>StatTrack</span> Battle-Scarred:<span className="price_skin">{props.event.st_cost_battle} $</span></p>
    <p>Factory New:<span className="price_skin">{props.event.cost_factory} $</span></p>
    <p className="Skins-cost-shadow">Minimal Wear:<span className="price_skin">{props.event.cost_minimal} $</span></p>
    <p>Field-Test:<span className="price_skin">{props.event.cost_field} $</span></p>
    <p className="Skins-cost-shadow">Well-Worm:<span className="price_skin">{props.event.cost_wellworm}$</span></p>
    <p>Battle-Scarred:<span className="price_skin">{props.event.cost_battle} $</span></p>
  </div>
</div>
  )
